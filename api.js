...
let sqlConnection = require("./db")

sqlConnection.query(`Select * from customer `, function (err, results3, field) {
    console.log(results3)
})
// Display all customers
router.get('/custdetails', (req, res) => {
    console.log("sdafg")
    var query = sqlConnection.query("Select * from customer", function (err, results, field) {
        console.log(results)
        res.json(results)
    })
